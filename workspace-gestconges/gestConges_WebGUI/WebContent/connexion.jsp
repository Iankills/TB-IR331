  			...
  			}else 
  			{
	    		...
	    		int id = Integer.parseInt(identifiant);
	  			...
	  			if(salarie == null)
	  			{
	  				...
	  				<a href="template.jsp?action=connexion">Retour...</a>
	  				<%
	  			}
	  			else if(!salarie.getPassword().equals(password))
	  			{
	  				...
	  				<%response.sendRedirect("template.jsp?action=connexion");%>
	  				<a href="index.jsp">Retour...</a>
	  				<%
	  			}
	  			else
