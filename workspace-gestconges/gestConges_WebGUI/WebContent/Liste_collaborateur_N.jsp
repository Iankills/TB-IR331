...
List<Salarie> salaries = gestionSalarie.listeSalaries();
%>
<html>
	<head>
  			 ...
  			 <tr>
  				...
  				<tr>
  					...
  					<td><%= conge.getDebutconges()%></td>
  					 ...
  					 <td>
  							<a href="template.jsp?action=Nok_Rh_conge&id_conge=<%=conge.getId()%>" style ="color: RED;"> NON </a>
  							<a> | </a>
  							<a href="template.jsp?action=Ok_Rh_conge&id_conge=<%=conge.getId()%>" style ="color: GREEN;">  OUI </a>
  					 </td>
  				</tr>
