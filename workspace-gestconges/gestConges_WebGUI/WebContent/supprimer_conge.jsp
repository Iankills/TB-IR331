...
for(Conge conge : conges) {
	if(conge.getId() == idConge){
		...
		else if(conge.getStatus().equals("Authorise N+1")){
		newSolde = s.getSoldePrev() + conge.getPeriode();
		s.setSoldePrev(newSolde);
		gestionSalarie.miseAJour(s);
		}
		else if(conge.getStatus().equals("cree")){
		newSolde = s.getSoldePrev() + conge.getPeriode();
		s.setSoldePrev(newSolde);
		gestionSalarie.miseAJour(s);
		}
