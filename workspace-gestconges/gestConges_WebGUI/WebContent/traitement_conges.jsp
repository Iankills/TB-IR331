...
<title>Traitement création candidature</title>
...
<body>
                    ...
                    %>
							<div class="erreur">    
  							<label >Le champ debutconges n'est pas rempli! Veuillez rentrez une date de début</label>    
					...
					<%
                                ...
                                <h2>Recapitulatif du congés <%=conge.getId()%> :</h2>
			   						<p><u>début du congé:</u> <%=conge.getDebutconges()%></p>  
                                <p><u>Fin du congés :</u> <%=conge.getFinconges()%></p>  
                                <p><u>Période :</u><%=conge.getPeriode()%></p>  
                                <p><u>Status :</u> <%=conge.getStatus()%></p>  
                                <%
                                }
                                else{
                                	%>
                                	<p> Si toute vos demande decongés sont validés par le RH.</p>
                                	<p> Votre Futur solde est inférieur au nombre de jour demandé </p>
                                	<p><a href="template.jsp?action=nouveau_conges">Retour à la demande de conges</a></p> 
                                <%
                                }
                                %>
