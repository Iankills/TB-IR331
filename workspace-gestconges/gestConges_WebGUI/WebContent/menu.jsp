...
<%
	...
	<link rel="stylesheet" href="styles.css" type="text/css" />
        ...
        <h3>Menu Conges</h3>
          ...
          <li class="menu"><a href="template.jsp?action=Liste_conge&id_salarie=<%=e.getId()%>">Liste de mes conges</a></li>
        </ul>
	      <hr/>
	      <h3>Menu messages</h3>
	      <ul>
        ...
        <h3>Menu Conges</h3>
	      <ul>
         <!-- <li class="menu"><a href="template.jsp?action=liste_conge&id=<%=m.getId()%>">Liste des conges à valider</a></li>-->
         <li class="menu"><a href="template.jsp?action=nouveau_conges">Nouveau conges</a></li>
         <li class="menu"><a href="template.jsp?action=Liste_conge&id_salarie=<%=m.getId()%>">Liste de mes conges</a>
        </ul>
	      <hr/>
	      <h3>Menu Administration</h3>
	      <ul>
	      <!--  <li class="menu"><a href="template.jsp?action=liste_messages">Messages recu</a></li>-->
	      <li class="menu"><a href="template.jsp?action=Liste_collaborateur&id_salarie=<%=m.getId()%>">Liste des conges à authoriser</a>
	      </ul>
	      <hr/>
		  		Poste : <i> Manager</i>
	      <%
        ...
        <h3>Menu Conges</h3>
	      <ul>
	         <!--<li class="menu"><a href="template.jsp?action=liste_conge&id=<%=r.getId()%>">Liste des conges à valider</a></li>-->
	         <li class="menu"><a href="template.jsp?action=nouveau_conges">Nouveau conges</a></li>
	         <li class="menu"><a href="template.jsp?action=Liste_conge&id_salarie=<%=r.getId()%>">Liste de mes conges</a></li>
          </ul>
	    <hr/>
	    <h3>Menu Administration</h3>
	      <ul>
	         <li class="menu"><a href="template.jsp?action=Liste_collaborateur_N&id_salarie=<%=r.getId()%>">Liste des conges à valider</a>
